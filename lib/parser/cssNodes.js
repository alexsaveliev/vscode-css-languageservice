...
(function (dependencies, factory) {
    ...
    (function (NodeType) {
        ...
        NodeType[NodeType["ImportSource"] = 52] = "ImportSource";
    ...
    var Stylesheet = (function (_super) {
        ...
        Stylesheet.prototype.getDependencies = function () {
            return this.dependencies.map(function (dep) { return dep.getName(); });
        };
        Stylesheet.prototype.addDependencies = function (src) {
    ...
    var ImportSource = (function (_super) {
        __extends(ImportSource, _super);
        function ImportSource(offset, length) {
            return _super.call(this, offset, length) || this;
        }
        Object.defineProperty(ImportSource.prototype, "type", {
            get: function () {
        ...
        ImportSource.prototype.getName = function () {
            return this.unquote(this.getText()).trim();
        };
        ImportSource.prototype.getPath = function () {
        ...
        ImportSource.prototype.unquote = function (text) {
    ...
    var Import = (function (_super) {
        ...
        Import.prototype.addSource = function (node) {
            if (node) {
