...
(function (dependencies, factory) {
    ...
    var Stylesheet = (function (_super) {
        ...
        function Stylesheet(offset, length) {
            var _this = _super.call(this, offset, length) || this;
            _this.dependencyMap = Object.create(null);
            return _this;
        }
        Stylesheet.prototype.getDependencies = function () {
            return this.dependencyMap;
        };
        Stylesheet.prototype.remDependencies = function (src) {
            var _this = this;
            src.map(function (dep) {
                delete _this.dependencyMap[dep];
            });
        };
        Stylesheet.prototype.addDependencies = function (src) {
            var _this = this;
            src.map(function (dep) {
                _this.dependencyMap[dep] = "";
            });
        };
    ...
    var Import = (function (_super) {
        ...
        Import.prototype.addSource = function (src) {
