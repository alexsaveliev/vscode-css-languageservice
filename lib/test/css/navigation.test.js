(function (dependencies, factory) {
...
})(["require", "exports", "assert", "../../parser/cssSymbolScope", "../../parser/cssNodes", "../../parser/cssParser", "../../services/cssNavigation", "../../services/cssUriResolver", "vscode-languageserver-types"], function (require, exports) {
    /*---------------------------------------------------------------------------------------------
    ...
    function assertHighlights(p, input, marker, expectedMatches, expectedWrites, elementName) {
        ...
        return asPromise(new cssNavigation_1.CSSNavigation(new cssUriResolver_1.CSSURIResolver).findDocumentHighlights(document, nodes.getNodeAtOffset(stylesheet, document.offsetAt(position)), new cssSymbolScope_1.Symbols(stylesheet), stylesheet)).then(function (highlights) {
