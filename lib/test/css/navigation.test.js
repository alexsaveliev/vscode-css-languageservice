(function (dependencies, factory) {
    ...
    function assertHighlights(p, input, marker, expectedMatches, expectedWrites, elementName) {
        ...
        return asPromise(new cssNavigation_1.CSSNavigation().findDocumentHighlights(document, nodes.getNodeAtOffset(stylesheet, document.offsetAt(position)), new cssSymbolScope_1.Symbols(stylesheet), stylesheet)).then(function (highlights) {
