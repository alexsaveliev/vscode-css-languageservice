(function (dependencies, factory) {
...
})(["require", "exports", "assert", "../../parser/cssParser", "../../parser/cssScanner", "../../parser/cssNodes", "../../parser/cssErrors"], function (require, exports) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('CSS - Parser', function () {
        test('Test stylesheet', function () {
            ...
            assertError('@mskeyframes darkWordHighlight { from { background-color: inherit; } to { background-color: rgba(83, 83, 83, 0.7); } }', parser, parser._parseStylesheet.bind(parser), cssErrors_1.ParseError.UnknownAtRule);
        ...
        test('Test media', function () {
            ...
            assertError('@media not, screen { }', parser, parser._parseMedia.bind(parser), cssErrors_1.ParseError.IdentifierExpected);
        ...
        test('page', function () {
            ...
            assertError('@page {  @XY foo { content: " "; border: solid green; } }', parser, parser._parsePage.bind(parser), cssErrors_1.ParseError.UnknownAtRule);
